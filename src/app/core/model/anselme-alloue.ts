...
export class AnselmeAlloue extends Person {
  ...
  protected override technoRawData: ITechnology[] = [
    {
      name: 'Angular',
  ...
  protected override projectRawData: IProject[] = [
    {
      title: 'MonBarra',
      placeholder:
    ...
    },
    {
      ...
      description:
        ...
        et participer à des ventes aux enchères. Gestion complète des utilisateurs avec système d'authentification,
        mise en ligne d'articles avec photos multiples, suivi en temps réel des enchères via WebSockets et système
    ...
    },
    {
      ...
      description:
        `Site d'actualités développé avec Laravel pour la diffusion d'informations en Côte d'Ivoire.
        CMS complet avec gestion des articles, catégories, commentaires et système de modération. Interface frontend
    ...
    },
    {
      ...
      placeholder:
        'Application web pour la mise en relation entre clients et livreurs',
      description:
        `Application de livraison développée avec Angular et Laravel, mettant en relation clients et livreurs.
        Interface client pour passer commande avec géolocalisation, estimation des coûts et suivi en temps réel.
        Application livreur avec gestion des courses, navigation GPS intégrée et historique des livraisons.
    ...
    },
    {
      ...
      placeholder:
        'Application web de transfert de fichiers sensibles avec chiffrement PGP et envoi SFTP',
      description:
        `Application web sécurisée permettant le transfert de fichiers sensibles avec chiffrement PGP de bout en bout
        et envoi automatisé vers un serveur SFTP. Chaque utilisateur dispose d'une clé PGP unique pour garantir
        la confidentialité et l'intégrité des données. L'interface intuitive développée en Angular permet l'upload,
        la gestion des clés, le chiffrement côté client avec OpenPGP.js et la traçabilité complète des transferts.
    ...
    {
      title:
        'Application d’authentification et de validation de signatures électroniques',
      placeholder:
        'Vérification automatisée des signatures électroniques sur documents uploadés',
      description:
        `Application web développée avec Angular et Quarkus pour le compte de Cryptoneo, autorité de certification.
        Elle permet aux utilisateurs de vérifier si une signature électronique est valide sur les documents qu'ils uploadent.
        Le projet inclut un mécanisme temps réel basé sur SSE (Server-Sent Events) pour informer l'utilisateur
